<div class="item-actions my-1">
    ...
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li><button type="submit" name="action" form="edit-form" class="btn btn-primary w-100" value="close">и закрыть</button></li>
            <li><button type="submit" name="action" form="edit-form" class="btn btn-primary w-100" value="edit">и редактировать</button></li>
            <li><button type="submit" name="action" form="edit-form" class="btn btn-primary w-100" value="new">и новый</button></li>
        </ul>
    </div>
</div>
