        ...
        <div id="panelsStayOpen-collapse{{ $blockId }}" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
                <div class="form-group row">
                    <div class="col-sm-12">
                        <input type="hidden" name="content[{{ $blockId }}][type]" value="img-and-text">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 box percent-100">
                        ...
                        <div class="form-check form-switch">
                            <input type="hidden" name="content[{{ $blockId }}][flow]" value="no">
                            <input type="checkbox" name="content[{{ $blockId }}][flow]" class="form-control form-check-input"
                                   value="yes"
                                    @checked(old('content['.$blockId.'][flow]', $block['flow']))>
                            <label class="form-check-label">Обтекание текстом</label>
                        </div>
                    </div>
                </div>
